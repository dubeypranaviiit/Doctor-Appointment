...
const AddDoctor = () => {
    ...
    const onSubmitHandler =async (e)=>{
        ...
        try{
            if(!docImg ) {
                return  toast.error('Profile pic not selected')
            }
...
<div className='bg-white px-8 py-8  border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
   ...
   <div className='flex items-center gap-4  mb-8 text-gray-500'>
    <label htmlFor="doc-img">
        ...
        src=
        { docImg ? URL.createObjectURL(docImg) :  assets_admin.upload_area} alt="upload image" />
    </label>
   ...
   <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600 '>
    <div className='w-full lg:flex-1 flex flex-col gap-4'>
           ...
           <div className='flex-1 flex flex-col gap-1' >
            ...
            value={password}
            className='border rounded px-3 py-2' type="password" placeholder='Name' required/>
           </div>
           <div className='flex-1 flex flex-col gap-1 '>
            <p>Experience </p>
            <select 
...
<option value="General physician">General physician</option>
        ...
        <option value="Gastroenterologist">Gastroenterologist</option>
           ...
           <div className='flex-1 flex flex-col gap-1 '>
            ...
            className='w-full px-4 pt-2 border rounded ' type="text" placeholder='Write about doctor' rows={5} required/>
           </div>


         <button 
         type='submit'
         className=' rounded-full bg-primary px-10 py-3 mt-4'>Add Doctor</button>
