...
{
  isEdit ?<input className='bg-gray-50 text-3xl font-medium max-w-62 mt-4 ' value={userData.name} type="text" onChange={(e)=>setUserData(prev=>({...prev,name:e.target.value}))} />
...
{
  isEdit ?<input className='max-w-28 bg-gray-100' value={userData.dob} type="date" onChange={(e)=>setUserData(prev=>({...prev,dob:e.target.value}))} />
