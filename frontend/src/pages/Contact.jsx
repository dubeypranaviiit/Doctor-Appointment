...
function Contact() {
  return (
    <div>
      ...
      <div className=' flex  flex-col justify-center item-starts gap-6 md:w-2/4 text-sm text-gray-600'>
        ...
        <p className='font-semibold text-lg text-gray-600'>Careers at PRESCRIPT O</p>
